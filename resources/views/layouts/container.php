      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 mb-xs-30">
          <div class="sidebar-block">
            ...
            <div class="mb-40 sidebar-box gray-box"> <span class="opener plus"></span>
              <div class="sidebar-title">
                <h3>Shop by</h3>
              </div>
              <div class="sidebar-contant">
            ...
            <div class="sidebar-box sidebar-item"> <span class="opener plus"></span>
              ...
              <div class="sidebar-contant">
                <ul>
                  <li>
                    <div class="pro-media"> <a><img alt="T-shirt" src="{{ asset('assets/images/products/item-small-1.jpg')}}"></a> </div>
                    <div class="pro-detail-info"> <a>Summer Women Nice Cloth</a>
                      <div class="price-box"> <span class="price">$80.00</span> </div>
                    </div>
                  </li>
                  <li>
                    <div class="pro-media"> <a><img alt="T-shirt" src="{{ asset('assets/images/products/item-small-2.jpg')}}"></a> </div>
                    <div class="pro-detail-info"> <a>Summer Women Nice Cloth</a>
                      <div class="price-box"> <span class="price">$80.00</span> </div>
                    </div>
                  </li>
                  <li>
                    <div class="pro-media"> <a><img alt="T-shirt" src="{{ asset('assets/images/products/item-small-3.jpg')}}"></a> </div>
                    <div class="pro-detail-info"> <a>Summer Women Nice Cloth</a>
                      <div class="price-box"> <span class="price">$80.00</span> </div>
                    </div>
                  </li>
        ...
        <div class="col-md-9 col-sm-8">
          <div class="shorting mb-30">
            <div class="row">
              <div class="col-md-6">
                <div class="view">
                  <div class="grid list-types active ">
                    <a href="shop.html">
