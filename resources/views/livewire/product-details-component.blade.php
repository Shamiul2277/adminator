        ...
        <div class="row">
          ...
          <div class="col-md-5 col-sm-5 mb-xs-30">
            <div class="fotorama" data-nav="thumbs" data-allowfullscreen="native">
              <a href="#"><img src="{{ asset('assets/images/products/item-large-1.jpg') }}" alt="Xpent Super Shop "></a>
              <a href="#"><img src="{{ asset('assets/images/products/item-large-2.jpg') }}" alt="Xpent Super Shop "></a>
              <a href="#"><img src="{{ asset('assets/images/products/item-large-3.jpg') }}" alt="Xpent Super Shop "></a>
              <a href="#"><img src="{{ asset('assets/images/products/item-large-4.jpg') }}" alt="Xpent Super Shop "></a>
              <a href="#"><img src="{{ asset('assets/images/products/item-large-5.jpg') }}" alt="Xpent Super Shop "></a>
              <a href="#"><img src="{{ asset('assets/images/products/item-large-6.jpg') }}" alt="Xpent Super Shop "></a>
              <a href="#"><img src="{{ asset('assets/images/products/item-large-7.jpg') }}" alt="Xpent Super Shop "></a>
              <a href="#"><img src="{{ asset('assets/images/products/item-large-8.jpg') }}" alt="Xpent Super Shop "></a>
            </div>
          </div>
              ...
              <div class="col-xs-12">
                <div class="product-detail-main">
                  <div class="product-item-details">
                    ...
                    <div class="mb-20 product-size select-arrow mt-30">
                      <label>Size</label>
                    ...
                    <div class="mb-20 product-color select-arrow">
                      <label>Color</label>
                      ...
                      <div class="items-Reviews gray-bg">
                        <div class="comments-area">
                          ...
                          <ul class="comment-list mt-30">
                            <li>
                              <div class="comment-user"> <img src="{{ asset('assets/images/comment-user.jpg') }}" alt="Xpent "> </div>
              ...
              <div class="owl-carousel pro_cat_slider">
                ...
                <div class="item">
                  <div class="product-item">
                    ...
                    <div class="product-image"> <a href="#"> <img src="{{ asset('assets/images/products/item-6.jpg') }}" alt="Xpent "> </a>
                ...
                <div class="item">
                  <div class="product-item">
                    <div class="product-image"> <a href="#"> <img src="{{ asset('assets/images/products/item-7.jpg') }}" alt="Xpent "> </a>
                      <div class="product-detail-inner">
                        <div class="item-overlay">
                          <ul>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="item">
                  <div class="product-item">
                    <div class="product-image"> <a href="#"> <img src="{{ asset('assets/images/products/item-8.jpg') }}" alt="Xpent "> </a>
                      <div class="product-detail-inner">
                        <div class="item-overlay">
                          <ul>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="item">
                  <div class="product-item">
                    <div class="product-image"> <a href="#"> <img src="{{ asset('assets/images/products/item-9.jpg') }}" alt="Xpent "> </a>
                      <div class="product-detail-inner">
                        <div class="item-overlay">
                          <ul>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="item">
                  <div class="product-item">
                    <div class="product-image"> <a href="#"> <img src="{{ asset('assets/images/products/item-10.jpg') }}" alt="Xpent "> </a>
                      <div class="product-detail-inner">
                        <div class="item-overlay">
                          <ul>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="item">
                  <div class="product-item">
                    <div class="product-image"> <a href="#"> <img src="{{ asset('assets/images/products/item-11.jpg') }}" alt="Xpent "> </a>
                      <div class="product-detail-inner">
                        <div class="item-overlay">
                          <ul>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
